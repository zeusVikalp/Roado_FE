...
class Search extends Component {
    ...
    // implementing debouncing feature to search within the existing list of words using lodash feature and regex expression
    ...
    render() {
        ...
        const { openDetailModal, modalData } = this.state   // handling modal view for 'after-click' on the result card
